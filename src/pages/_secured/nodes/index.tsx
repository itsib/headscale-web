...
import { NodesContextMenuAction, NodesContextMenu } from '@app-components/nodes-context-menu/nodes-context-menu';
...
export const Route = createFileRoute('/_secured/nodes/')({
...
function Component() {
  ...
  const { nodes: _nodes, dataUpdatedAt } = Route.useLoaderData() as {
    nodes: Node[];
