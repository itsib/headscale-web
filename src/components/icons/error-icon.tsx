...
export const ErrorIcon = forwardRef(function ErrorIcon(props: IconBaseProps, ref: ForwardedRef<SVGSVGElement>) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" style={style} className={className} ref={ref}>
      <g fill="none" stroke="rgb(var(--error))" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}>
        <path
          fill="rgb(var(--error))"
          fillOpacity={0}
          strokeDasharray={64}
        ...
        <path strokeDasharray={8} strokeDashoffset={8} d="M12 12l4 4M12 12l-4 -4M12 12l-4 4M12 12l4 -4">
          <animate fill="freeze" attributeName="stroke-dashoffset" begin="0.75s" dur="0.2s" values="8;0"></animate>
        </path>
      </g>
    </svg>
  );
