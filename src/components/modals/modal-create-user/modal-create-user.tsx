...
export interface ModalCreateUserProps extends ModalProps {
  onSuccess: () => void;
}

export const ModalCreateUser: FC<ModalCreateUserProps> = ({ isOpen, onDismiss, ...props }) => {
  return (
...
const ModalContent: FC<Omit<ModalCreateUserProps, 'isOpen'>> = ({ onDismiss, onSuccess }) => {
